...
CONFIG_TRAIN_ITERATIONS_SUBKEY = "Iterations"
CONFIG_TRAIN_ITERATIONS_MAIN_SUBSUBKEY = "Main"
CONFIG_TRAIN_ITERATIONS_GEN_SUBSUBKEY = "Gen"
CONFIG_TRAIN_ITERATIONS_DISC_SUBSUBKEY = "Disc"
...
CONFIG_DEBUG_INTERVALS_PRINTLOSSGEN_SUBSUBKEY = "PrintLossGen"
CONFIG_DEBUG_INTERVALS_PRINTLOSSDISC_SUBSUBKEY = "PrintLossDisc"
...
class ConfigLoader:
	...
	def load_configs(self):
		...
		self.num_iter_main = self._config[CONFIG_TRAIN_KEY][CONFIG_TRAIN_ITERATIONS_SUBKEY][CONFIG_TRAIN_ITERATIONS_MAIN_SUBSUBKEY]
		self.num_iter_gen = self._config[CONFIG_TRAIN_KEY][CONFIG_TRAIN_ITERATIONS_SUBKEY][CONFIG_TRAIN_ITERATIONS_GEN_SUBSUBKEY]
		self.num_iter_disc = self._config[CONFIG_TRAIN_KEY][CONFIG_TRAIN_ITERATIONS_SUBKEY][CONFIG_TRAIN_ITERATIONS_DISC_SUBSUBKEY]
		...
		self.print_interval_loss_gen = self._config[CONFIG_DEBUG_KEY][CONFIG_DEBUG_INTERVALS_SUBKEY][CONFIG_DEBUG_INTERVALS_PRINTLOSSGEN_SUBSUBKEY]
		self.print_interval_loss_disc = self._config[CONFIG_DEBUG_KEY][CONFIG_DEBUG_INTERVALS_SUBKEY][CONFIG_DEBUG_INTERVALS_PRINTLOSSDISC_SUBSUBKEY]
